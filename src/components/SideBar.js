...
function SideBar() {
    return (
      <React.Fragment>
        <aside className="sidebar sidebar-default sidebar-two navs-pill sidebar-mini d-xl-flex flex-column">
          <div className="sidebar-header d-flex align-items-center justify-content-start">
              <a href="/dashboard" className="navbar-brand">
                   <img src="img/BCA.png" style={{width:"30px"}} alt="img"/>
                  </a>
          </div>
          <div className="sidebar-body pt-0 data-scrollbar flex-fill">
              <div className="sidebar-list">
                  <ul className="navbar-nav iq-main-menu nav nav-tabs" id="sidebar-menu" role="tablist">
                      <li className="nav-item">
                          <Link className="nav-link active" aria-current="page"  to="/dashboard" data-sidebar-toggle="tooltip" data-bs-placement="right" title="Dashboard">
                        ...
                        <li className="nav-item">
                                <Link className="nav-link active" aria-current="page" to="/cars" data-sidebar-toggle="tooltip" data-bs-placement="right" title="Mijn auto's">
                                    <small>Mijn auto's</small>
                                <i className="icon">
                      ...
                      {/* <li className="nav-item">
                          <Link className="nav-link active" aria-current="page" to="/carOnSale" data-sidebar-toggle="tooltip" data-bs-placement="right" title="Car On Sale">
                          <small>Car On Sale</small>
                              <i className="icon">
                              <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path>
                                  </svg>
                      ...
                      {/* <li className="nav-item">
                          <Link className="nav-link active" aria-current="page" to="/carRecord" data-sidebar-toggle="tooltip" data-bs-placement="right" title="Dashboard">
                              <i className="icon">
                              <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path>
                                  </svg>
                      ...
                      <li className="nav-item">
                          <Link className="nav-link active" aria-current="page" to="/addCar" data-sidebar-toggle="tooltip" data-bs-placement="right" title="Dashboard">
                              <i className="icon">
                              <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path>
                                  </svg>
                      ...
                      {/* <li className="nav-item">
                          <Link className="nav-link active" aria-current="page" to="/carAuction" data-sidebar-toggle="tooltip" data-bs-placement="right" title="Auction">
                          <small>Auction</small>
      ...
      <div className="tab-content sidebar sidebar-default navs-rounded-all  in-active " id="nav-tabContent"> 
          <div className="sidebar-header d-flex align-items-center justify-content-start">
              <a href="../dashboard/index.html" className="navbar-brand">
                  <img src="img/logo.png" className="img-fluid" alt="logo-big"/>
              </a>
          ...
          <div className="tab-pane fade show active" id="sidebar-auths" role="tabpanel" aria-labelledby="auth-pages">
              <div className="sidebar-body">
                  <ul className="navbar-nav" id="sidebar-menu-auth">
                      <li className="nav-item">
                          <a className="nav-link" data-bs-toggle="collapse" href="#sidebar-auth" role="button" aria-expanded="true" aria-controls="sidebar-menu-auth">
                              <i className="icon">
                                  <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="tab-pane fade" id="sidebar-users" role="tabpanel" aria-labelledby="users-pages">
              <div className="sidebar-body">
                  <ul className="navbar-nav" id="sidebar-menu-users">
                      <li className="nav-item">
                          <a className="nav-link" data-bs-toggle="collapse" href="#sidebar-user" role="button" aria-expanded="true" aria-controls="sidebar-menu-users">
                              <i className="icon">
                                  <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="tab-pane fade" id="sidebar-utilitiess" role="tabpanel" aria-labelledby="users-error">
              <div className="sidebar-body">
                  <ul className="navbar-nav" id="sidebar-menu-utilities">
                      <li className="nav-item">
                          <a className="nav-link" data-bs-toggle="collapse" href="#sidebar-utilities" role="button" aria-expanded="true" aria-controls="sidebar-menu-utilities">
                              <i className="icon">
                                  <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
